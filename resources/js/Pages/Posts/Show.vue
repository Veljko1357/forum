    ...
    <AppLayout :title="post.title">
        <Container>
            ...
            <div class="mt-12">
                ...
                <!-- prevent showing the form if user is not logged in-->
                <form v-if="$page.props.auth.user" @submit.prevent="addComment" class="mt-4">
                    <div>
                        ...
                        <!-- InputError prevents posting blank comments and going over the character limit of 2500 with an error message-->
                       
                        <InputError :message="commentForm.errors.body" class="mt-1" />
                    </div>

                      <!-- :disable="commentForm.processing - in case of slow connection prevent posting one comment multiple times -->
